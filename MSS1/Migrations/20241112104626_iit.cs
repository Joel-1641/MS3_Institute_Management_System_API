            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdminId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AdminRoleType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Department = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AdminPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastLoginDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    HasFinancialAccess = table.Column<bool>(type: "bit", nullable: false),
                    HasCourseManagementAccess = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
